        ...
        <>
            <main
                ...
                <div className="mt-10 sm:mx-auto sm:max-w-lg">
                    <form className="space-y-6" onSubmit={handleSubmit} method="post">
                        ...
                        <div>
                            <button
                                ...
                                {
                                    isLoading ? <div className='icons'><IconDefault type='loading' width={24} /></div> :
                                        isSuccess ? <div className='icons'><IconDefault type='success' color='white' width={30} /></div> :
                                            isError ? <div className='icons'><IconDefault type='error' width={30} color='white' /></div> : 'Register'}
                            </button>
                        </div>
                    </form>
                    ...
                    <ProviderButton action='Register' provider='google' />
                </div>
            </main>
